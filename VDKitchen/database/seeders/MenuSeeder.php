...
class MenuSeeder extends Seeder
{
    public function run()
    {
        $menus = [
            // Foods
            ['name' => 'Nasi Tim Ayam', 'price' => 24000, 'image' => 'menu1.jpg', 'category' => 'food'],
            ['name' => 'Mie Ayam', 'price' => 19000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Mie Ayam Yamin', 'price' => 20000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Mie Kangkung Ayam', 'price' => 24000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Bihun Ayam', 'price' => 19000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Bihun Ayam Yamin', 'price' => 20000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Bihun Kangkung Ayam', 'price' => 24000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Kwetiau Ayam', 'price' => 19000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ...
            ['name' => 'Locupan Ayam', 'price' => 22000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ['name' => 'Baso Ikan/Sapi (isi 5)', 'price' => 16000, 'image' => 'menu2.jpg', 'category' => 'food'],
            ...
            ['name' => 'Minuman Badak', 'price' => 15000, 'image' => 'menu2.jpg', 'category' => 'drink'],
        ];
